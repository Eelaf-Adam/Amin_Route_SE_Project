const CACHE_NAME = 'amin-route-v3';
...
self.addEventListener('fetch', (event) => {
  ...
  // Bypass Service Worker completely for non-GET requests (e.g. POST /api/auth/login)
  if (request.method !== 'GET') {
    return;
  }

  // Strategy A: Cache-First for OpenStreetMap tiles & images
  ...
  // Strategy B: Network-First for GET API requests
